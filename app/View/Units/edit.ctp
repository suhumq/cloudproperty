<div class="row-fluid">
    <div class="span6">
		<h3 class="heading">Edit Unit Baru</h3>
			...
			<div class="formSep">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<?php
						echo $this->Form->text('charge', array('class' => 'span8 number currency', 'minlength' => '1')); ?>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						...
						<?php
						echo $this->Form->text('downpayment', array('class' => 'span8 required number currency', 'minlength' => '1')); ?>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						...
						<?php
						echo $this->Form->text('fee', array('class' => 'span8 required number currency', 'minlength' => '1')); ?>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						...
						<?php
						echo $this->Form->text('plafond', array('class' => 'span8 required number currency', 'minlength' => '1')); ?>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
