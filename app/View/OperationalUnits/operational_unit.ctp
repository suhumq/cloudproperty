...
<div class="span12">
	<h3 class="heading">Tambah <b>REAL COST</b> Operasional Unit</h3>
	<?php  echo $this->Form->create('OperationalUnit', array('action' => 'addJurnalOprUnit',  'class'=>'form_validation_ttip')); ?>
		<div class="formSep">
			<div class="row-fluid">  
				<div class="span2">
					...
					<?php echo $this->Form->input('account_debet', array('label' => '','type' => 'hidden', 'value' => 'Persediaan Barang Property','class' => 'span12 required', 'minlength' => '3')); ?>
					<?php echo $this->Form->input('account_credit', array('label' => '','type' => 'hidden', 'value' => 'Kas/Bank','class' => 'span12 required', 'minlength' => '3')); ?>
					<?php echo $this->Form->input('no_transaction', array('label' => '','type' => 'text', 'class' => 'span12 required', 'readonly' =>'true', 'minlength' => '3', 'value' => 'ROU2013' . (string)$invoice[0][0]['MAX(id)']  )); ?>
					<?php echo $this->Form->input('unit_id', array('label' => '','type' => 'hidden', 'class' => 'span12 required', 'minlength' => '3')); ?>
				</div>
				<div class="span2">
